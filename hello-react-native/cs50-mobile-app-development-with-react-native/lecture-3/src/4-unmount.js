// play with unmount cycle (show why we need to cleanup)
...
class Counter extends React.Component {
  ...
  // without this the timers would keep getting called even after the component disappears
  // memory leak
...
export default class App extends React.Component {
  ...
  render() {
    if (this.state.showCounter) {
      ...
      // this triggers Counter's unmount cycle (since Counter "dies")
      return (
        <View style={styles.appContainer}>
          <Button title="toggle" onPress={this.toggleCounter} />
        </View>
