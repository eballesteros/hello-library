...
// The original was wrong. According to ChatGPT: "The function should return a number instead of a boolean value. 
// You can modify the function to return a negative value if contact1.name is less than contact2.name, zero if 
// they are equal, and a positive value if contact1.name is greater than contact2.name"
export const compareNames = (contact1, contact2) => contact1.name.localeCompare(contact2.name);

// add keys to based on index
// shorthand: {key,} is an abbreviation of {key:key}
// array destructuring: ...val explodes val (also exists for objects)
// so this is equivalent to:
// const addKeys = (key, contact) => (
//     {
//         key:key, 
//         name:contact.name,
//         phone:contact.phone
//     }
// )
// clone value and dd key 
const addKeys = (val, key) => ({key, ...val})

// create an array of length NUM_CONTACTS and alphabetize by name
// this creates an empty array of length=NUM_CONTACTS
// then populates it with createContact
// then maps addKey
